...
//   const [previousYards, setPreviousYards] = useState(0);
...
//             const productData = docSnap.data();
//             setProduct(productData);
//             setInitialStock(productData.stock || 0); // Store the initial stock value
//           } else {
//             console.error("No product found with ID:", productId);
//           }
//         } catch (error) {
...
//   // Handle yard input and stock update
//   const handleYardsChange = async (e) => {
//     const newYards = parseInt(e.target.value, 10) || 0;

//     if (!newYards) {
//       if (product) {
//         try {
//           const productRef = doc(db, "newproducts", productId);
//           await updateDoc(productRef, { stock: initialStock });
//           setProduct((prev) => ({ ...prev, stock: initialStock }));
//           setPreviousYards(0);
//           setSelectedSize("");
//         } catch (error) {
//           console.error("Error reverting stock:", error);
...
//     if (product) {
//       const revertedStock = product.stock + previousYards;
//       const newStock = revertedStock - newYards;
...
//         setPreviousYards(newYards);
//         setSelectedSize(newYards);
//       } catch (error) {
//         console.error("Error updating stock:", error);
//       }
//     }
...
//     try {
//       const selectedQuantity =
//         product.category === "Fabrics" ? parseInt(selectedSize, 10) : 1;
...
//         guestCart[existingItemIndex].quantity += selectedQuantity;
//       } else {
